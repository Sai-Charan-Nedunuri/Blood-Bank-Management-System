    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        try{
            ...
            statement.executeUpdate("update donor set name='"+donor.getName()+"',fatherName='"+donor.getFatherName()+"',motherName="
                    + "'"+donor.getMotherName()+"',DOB='"+donor.getDateOfBirth()+"',mobileNo='"+donor.getMobileNo()+"',gender='"+donor.getGender()+"',email='"+donor.getEmail()+"',bloodGroup='"+donor.getBloodGroup()+"', city='"+donor.getCity()+"',address='"+donor.getAddress()+"'where donorId='"+donor.getDonorId()+"'");
